...
pub fn StoryNodeComponent(
    ...
    view! {
        ...
        >
            // Station Roof / Header
            <div class="p-3 border-b-2 flex justify-between items-start rounded-t-lg bg-slate-900/90 border-slate-700">
            ...
            <div class="p-4 text-slate-300 text-sm font-mono min-h-[80px] relative bg-neutral-900/90">
