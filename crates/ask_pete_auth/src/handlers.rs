...
pub async fn google_callback(Query(query): Query<AuthRequest>) -> impl IntoResponse {
    let client = get_oauth_client();
...
fn get_oauth_client() -> BasicClient {
    ...
    let redirect_url = "http://localhost:3000/auth/callback";
